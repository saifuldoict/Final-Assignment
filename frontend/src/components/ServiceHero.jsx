    ...
    return (
        <div>
            <div className="font-sans">
                <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-gradient-to-tl from-blue-50 via-blue-100  rounded-fulls    dark:from-indigo-900/70 dark:via-indigo-900/70 dark:to-blue-900/70 bg-gradient-to-r from-violet-300/50 to-purple-100  dark:from-violet-900/50 dark:to-purple-900">
                ...
                <div className="text-center mb-5">
                    <h1 className="text-5xl font-bold">Service Available Now!</h1>
                </div>
            </div>
        </div>
    );
